# Creamos una función que ordene las palabras usando sorted
# '.join' es para concatenación de cadenas
def ordenar_palabra(palabra):
    return ''.join(sorted(palabra))

# Solicitamos el número de palabras para el diccionario con N y las palabras que se guardan en diccionario
...
#Solicitamos el número de consultas denotada por Q
